...
export const WEAPONS = {
  pistol: {
    ...
    kind: 'flak', vm: 'pistol',
    ammo: AMMO_FLAK, cost: 1, refire: 0.62,
    flakSpeed: 112, blastRadius: 5.4, spread: 0.0, pellets: 1,
  ...
  splitter: {
    ...
    ammo: AMMO_FLAK, cost: 3, refire: 0.92,
    flakSpeed: 104, blastRadius: 4.3, spread: 0.055, pellets: 3,
  ...
  halo: {
    ...
    kind: 'ring', vm: 'halo',
    ammo: AMMO_FLAK, cost: 8, refire: 1.35,
    flakSpeed: 96, blastRadius: 6.2, ringRadius: 15.5, ringCount: 7,
    spread: 0, pellets: 1,
...
export const AMMO_MAX = { [AMMO_FLAK]: 140, [AMMO_NAIL]: 320, [AMMO_CHARGE]: 3 };
